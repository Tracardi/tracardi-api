...
async def test_should_set_up_plugin_tag_event_action():
    ...
    module = import_package("wf.plugin.v1.internal.tag_event.plugin")
    plugin_class = load_callable(module, "TagEventAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.internal.tag_event.plugin", 
...
async def test_should_set_up_plugin_last_visit_action():
    ...
    module = import_package("wf.plugin.v1.time.last_profile_visit.plugin")
    plugin_class = load_callable(module, "LastVisitAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.time.last_profile_visit.plugin", 
...
async def test_should_set_up_plugin_telegram_post_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.telegram.post.plugin")
    plugin_class = load_callable(module, "TelegramPostAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.telegram.post.plugin", 
...
async def test_should_set_up_plugin_google_analytics_event_tracker_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.google.analytics.plugin")
    plugin_class = load_callable(module, "GoogleAnalyticsEventTrackerAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.google.analytics.plugin", 
...
async def test_should_set_up_plugin_google_analytics_v4_event_tracker_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.google.analytics_v4.plugin")
    plugin_class = load_callable(module, "GoogleAnalyticsV4EventTrackerAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.google.analytics_v4.plugin", 
...
async def test_should_set_up_plugin_whois_action():
    ...
    module = import_package("wf.plugin.v1.connectors.whois.plugin")
    plugin_class = load_callable(module, "WhoisAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.whois.plugin", 
...
async def test_should_set_up_plugin_contains_pattern_action():
    ...
    module = import_package("wf.plugin.v1.operations.contains_pattern.plugin")
    plugin_class = load_callable(module, "ContainsPatternAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.operations.contains_pattern.plugin", 
...
async def test_should_set_up_plugin_payload_memory_collector():
    ...
    module = import_package("wf.plugin.v1.memory.collect.plugin")
    plugin_class = load_callable(module, "PayloadMemoryCollector")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.memory.collect.plugin", 
...
async def test_should_set_up_plugin_password_generator_action():
    ...
    module = import_package("wf.plugin.v1.password_generator_action")
    plugin_class = load_callable(module, "PasswordGeneratorAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.password_generator_action", 
...
async def test_should_set_up_plugin_week_days_checker():
    ...
    module = import_package("wf.plugin.v1.weekdays_checker_action")
    plugin_class = load_callable(module, "WeekDaysChecker")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.weekdays_checker_action", 
...
async def test_should_set_up_plugin_start_action():
    ...
    module = import_package("wf.plugin.v1.flow.start.start_action")
    plugin_class = load_callable(module, "StartAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.flow.start.start_action", 
...
async def test_should_set_up_plugin_property_exists_action():
    ...
    module = import_package("wf.plugin.v1.flow.property_exists.plugin")
    plugin_class = load_callable(module, "PropertyExistsAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.flow.property_exists.plugin", 
...
async def test_should_set_up_plugin_end_action():
    ...
    module = import_package("wf.plugin.v1.end_action")
    plugin_class = load_callable(module, "EndAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.end_action", 
                       className="EndAction")
    await plugin.set_up({})
...
async def test_should_set_up_plugin_raise_error_action():
    ...
    module = import_package("wf.plugin.v1.raise_error_action")
    plugin_class = load_callable(module, "RaiseErrorAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.raise_error_action", 
...
async def test_should_set_up_plugin_inject_action():
    ...
    module = import_package("wf.plugin.v1.inject_action")
    plugin_class = load_callable(module, "InjectAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.inject_action", 
...
async def test_should_set_up_plugin_increase_views_action():
    ...
    module = import_package("wf.plugin.v1.increase_views_action")
    plugin_class = load_callable(module, "IncreaseViewsAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.increase_views_action", 
...
async def test_should_set_up_plugin_increase_visits_action():
    ...
    module = import_package("wf.plugin.v1.increase_visits_action")
    plugin_class = load_callable(module, "IncreaseVisitsAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.increase_visits_action", 
...
async def test_should_set_up_plugin_increment_action():
    ...
    module = import_package("wf.plugin.v1.increment_action")
    plugin_class = load_callable(module, "IncrementAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.increment_action", 
...
async def test_should_set_up_plugin_decrement_action():
    ...
    module = import_package("wf.plugin.v1.decrement_action")
    plugin_class = load_callable(module, "DecrementAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.decrement_action", 
...
async def test_should_set_up_plugin_if_action():
    ...
    module = import_package("wf.plugin.v1.if_action")
    plugin_class = load_callable(module, "IfAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.if_action", 
                       className="IfAction")
...
async def test_should_set_up_plugin_starts_with_action():
    ...
    module = import_package("wf.plugin.v1.starts_with_action")
    plugin_class = load_callable(module, "StartsWithAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.starts_with_action", 
...
async def test_should_set_up_plugin_ends_with_action():
    ...
    module = import_package("wf.plugin.v1.ends_with_action")
    plugin_class = load_callable(module, "EndsWithAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.ends_with_action", 
...
async def test_should_set_up_plugin_new_visit_action():
    ...
    module = import_package("wf.plugin.v1.new_visit_action")
    plugin_class = load_callable(module, "NewVisitAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.new_visit_action", 
...
async def test_should_set_up_plugin_new_profile_action():
    ...
    module = import_package("wf.plugin.v1.new_profile_action")
    plugin_class = load_callable(module, "NewProfileAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.new_profile_action", 
...
async def test_should_set_up_plugin_template_action():
    ...
    module = import_package("wf.plugin.v1.template_action")
    plugin_class = load_callable(module, "TemplateAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.template_action", 
...
async def test_should_set_up_plugin_sorted_dict_action():
    ...
    module = import_package("wf.plugin.v1.sort_dictionary")
    plugin_class = load_callable(module, "SortedDictAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.sort_dictionary", 
...
async def test_should_set_up_plugin_get_uuid4_action():
    ...
    module = import_package("wf.plugin.v1.misc.uuid4.plugin")
    plugin_class = load_callable(module, "GetUuid4Action")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.misc.uuid4.plugin", 
...
async def test_should_set_up_plugin_copy_trait_action():
    ...
    module = import_package("wf.plugin.v1.traits.copy_trait_action")
    plugin_class = load_callable(module, "CopyTraitAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.traits.copy_trait_action", 
...
async def test_should_set_up_plugin_append_trait_action():
    ...
    module = import_package("wf.plugin.v1.traits.append_trait_action")
    plugin_class = load_callable(module, "AppendTraitAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.traits.append_trait_action", 
...
async def test_should_set_up_plugin_cut_out_trait_action():
    ...
    module = import_package("wf.plugin.v1.traits.cut_out_trait_action")
    plugin_class = load_callable(module, "CutOutTraitAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.traits.cut_out_trait_action", 
...
async def test_should_set_up_plugin_delete_trait_action():
    ...
    module = import_package("wf.plugin.v1.traits.delete_trait_action")
    plugin_class = load_callable(module, "DeleteTraitAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.traits.delete_trait_action", 
...
async def test_should_set_up_plugin_auto_merge_properties_to_profile_action():
    ...
    module = import_package("wf.plugin.v1.traits.auto_merge_properties_to_profile_action")
    plugin_class = load_callable(module, "AutoMergePropertiesToProfileAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.traits.auto_merge_properties_to_profile_action", 
...
async def test_should_set_up_plugin_assign_condition_result_plugin():
    ...
    module = import_package("wf.plugin.v1.traits.assign_condition_result.plugin")
    plugin_class = load_callable(module, "AssignConditionResultPlugin")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.traits.assign_condition_result.plugin", 
...
async def test_should_set_up_plugin_condition_set_plugin():
    ...
    module = import_package("wf.plugin.v1.traits.condition_set.plugin")
    plugin_class = load_callable(module, "ConditionSetPlugin")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.traits.condition_set.plugin", 
...
async def test_should_set_up_plugin_hash_traits_action():
    ...
    module = import_package("wf.plugin.v1.traits.hash_traits_action")
    plugin_class = load_callable(module, "HashTraitsAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.traits.hash_traits_action", 
...
async def test_should_set_up_plugin_mask_traits_action():
    ...
    module = import_package("wf.plugin.v1.traits.mask_traits_action")
    plugin_class = load_callable(module, "MaskTraitsAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.traits.mask_traits_action", 
...
async def test_should_set_up_plugin_join_payloads():
    ...
    module = import_package("wf.plugin.v1.operations.join_payloads.plugin")
    plugin_class = load_callable(module, "JoinPayloads")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.operations.join_payloads.plugin", 
...
async def test_should_set_up_plugin_merge_profiles_action():
    ...
    module = import_package("wf.plugin.v1.operations.merge_profiles_action")
    plugin_class = load_callable(module, "MergeProfilesAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.operations.merge_profiles_action", 
...
async def test_should_set_up_plugin_update_profile_action():
    ...
    module = import_package("wf.plugin.v1.operations.update_profile_action")
    plugin_class = load_callable(module, "UpdateProfileAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.operations.update_profile_action", 
...
async def test_should_set_up_plugin_discard_profile_update_action():
    ...
    module = import_package("wf.plugin.v1.operations.discard_profile_update_action")
    plugin_class = load_callable(module, "DiscardProfileUpdateAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.operations.discard_profile_update_action", 
...
async def test_should_set_up_plugin_update_session_action():
    ...
    module = import_package("wf.plugin.v1.operations.update_session_action")
    plugin_class = load_callable(module, "UpdateSessionAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.operations.update_session_action", 
...
async def test_should_set_up_plugin_array_reducer():
    ...
    module = import_package("wf.plugin.v1.operations.reduce_array.plugin")
    plugin_class = load_callable(module, "ArrayReducer")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.operations.reduce_array.plugin", 
...
async def test_should_set_up_plugin_calculator_action():
    ...
    module = import_package("wf.plugin.v1.calculator_action")
    plugin_class = load_callable(module, "CalculatorAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.calculator_action", 
...
async def test_should_set_up_plugin_mapping_action():
    ...
    module = import_package("wf.plugin.v1.mapping_action")
    plugin_class = load_callable(module, "MappingAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.mapping_action", 
...
async def test_should_set_up_plugin_random_item_action():
    ...
    module = import_package("wf.plugin.v1.return_random_element_action")
    plugin_class = load_callable(module, "RandomItemAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.return_random_element_action", 
...
async def test_should_set_up_plugin_log_action():
    ...
    module = import_package("wf.plugin.v1.log_action")
    plugin_class = load_callable(module, "LogAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.log_action", 
                       className="LogAction")
...
async def test_should_set_up_plugin_html_xpath_scrapper_action():
    ...
    module = import_package("wf.plugin.v1.scrapper.xpath.plugin")
    plugin_class = load_callable(module, "HtmlXpathScrapperAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.scrapper.xpath.plugin", 
...
async def test_should_set_up_plugin_value_threshold_action():
    ...
    module = import_package("wf.plugin.v1.operations.threshold.plugin")
    plugin_class = load_callable(module, "ValueThresholdAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.operations.threshold.plugin", 
...
async def test_should_set_up_plugin_circular_geo_fence_action():
    ...
    module = import_package("wf.plugin.v1.geo.fence.circular.plugin")
    plugin_class = load_callable(module, "CircularGeoFenceAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.geo.fence.circular.plugin", 
...
async def test_should_set_up_plugin_geo_distance_action():
    ...
    module = import_package("wf.plugin.v1.geo.distance.plugin")
    plugin_class = load_callable(module, "GeoDistanceAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.geo.distance.plugin", 
...
async def test_should_set_up_plugin_reshape_payload_action():
    ...
    module = import_package("wf.plugin.v1.traits.reshape_payload_action")
    plugin_class = load_callable(module, "ReshapePayloadAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.traits.reshape_payload_action", 
...
async def test_should_set_up_plugin_detect_client_agent_action():
    ...
    module = import_package("wf.plugin.v1.detect_client_agent_action")
    plugin_class = load_callable(module, "DetectClientAgentAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.detect_client_agent_action", 
...
async def test_should_set_up_plugin_field_type_action():
    ...
    module = import_package("wf.plugin.v1.traits.field_type_action")
    plugin_class = load_callable(module, "FieldTypeAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.traits.field_type_action", 
...
async def test_should_set_up_plugin_string_properties_actions():
    ...
    module = import_package("wf.plugin.v1.strings.string_operations.plugin")
    plugin_class = load_callable(module, "StringPropertiesActions")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.strings.string_operations.plugin", 
...
async def test_should_set_up_plugin_regex_match_action():
    ...
    module = import_package("wf.plugin.v1.strings.regex_match.plugin")
    plugin_class = load_callable(module, "RegexMatchAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.strings.regex_match.plugin", 
...
async def test_should_set_up_plugin_regex_validator_action():
    ...
    module = import_package("wf.plugin.v1.strings.regex_validator.plugin")
    plugin_class = load_callable(module, "RegexValidatorAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.strings.regex_validator.plugin", 
...
async def test_should_set_up_plugin_string_validator_action():
    ...
    module = import_package("wf.plugin.v1.strings.string_validator.plugin")
    plugin_class = load_callable(module, "StringValidatorAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.strings.string_validator.plugin", 
...
async def test_should_set_up_plugin_splitter_action():
    ...
    module = import_package("wf.plugin.v1.strings.string_splitter.plugin")
    plugin_class = load_callable(module, "SplitterAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.strings.string_splitter.plugin", 
...
async def test_should_set_up_plugin_join_action():
    ...
    module = import_package("wf.plugin.v1.strings.string_join.plugin")
    plugin_class = load_callable(module, "JoinAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.strings.string_join.plugin", 
...
async def test_should_set_up_plugin_parse_u_r_l_parameters():
    ...
    module = import_package("wf.plugin.v1.strings.url_parser.plugin")
    plugin_class = load_callable(module, "ParseURLParameters")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.strings.url_parser.plugin", 
...
async def test_should_set_up_plugin_regex_replacer():
    ...
    module = import_package("wf.plugin.v1.strings.regex_replace.plugin")
    plugin_class = load_callable(module, "RegexReplacer")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.strings.regex_replace.plugin", 
...
async def test_should_set_up_plugin_search_string_similarity_action():
    ...
    module = import_package("wf.plugin.v1.strings.string_similarity.plugin")
    plugin_class = load_callable(module, "SearchStringSimilarityAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.strings.string_similarity.plugin", 
...
async def test_should_set_up_plugin_sleep_action():
    ...
    module = import_package("wf.plugin.v1.time.sleep_action")
    plugin_class = load_callable(module, "SleepAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.time.sleep_action", 
...
async def test_should_set_up_plugin_today_action():
    ...
    module = import_package("wf.plugin.v1.time.today_action")
    plugin_class = load_callable(module, "TodayAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.time.today_action", 
...
async def test_should_set_up_plugin_day_night_action():
    ...
    module = import_package("wf.plugin.v1.time.day_night.plugin")
    plugin_class = load_callable(module, "DayNightAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.time.day_night.plugin", 
...
async def test_should_set_up_plugin_local_time_span_action():
    ...
    module = import_package("wf.plugin.v1.time.local_time_span.plugin")
    plugin_class = load_callable(module, "LocalTimeSpanAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.time.local_time_span.plugin", 
...
async def test_should_set_up_plugin_profile_live_time_action():
    ...
    module = import_package("wf.plugin.v1.time.profile_live_time.plugin")
    plugin_class = load_callable(module, "ProfileLiveTimeAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.time.profile_live_time.plugin", 
...
async def test_should_set_up_plugin_time_diff_calculator():
    ...
    module = import_package("wf.plugin.v1.time.time_difference.plugin")
    plugin_class = load_callable(module, "TimeDiffCalculator")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.time.time_difference.plugin", 
...
async def test_should_set_up_plugin_consent_ux():
    ...
    module = import_package("wf.plugin.v1.ux.consent.plugin")
    plugin_class = load_callable(module, "ConsentUx")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.ux.consent.plugin", 
                       className="ConsentUx")
...
async def test_should_set_up_plugin_html_page_fetch_action():
    ...
    module = import_package("wf.plugin.v1.connectors.html.fetch.plugin")
    plugin_class = load_callable(module, "HtmlPageFetchAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.html.fetch.plugin", 
...
async def test_should_set_up_plugin_remote_call_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.api_call.plugin")
    plugin_class = load_callable(module, "RemoteCallAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.api_call.plugin", 
...
async def test_should_set_up_plugin_smtp_dispatcher_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.smtp_call.plugin")
    plugin_class = load_callable(module, "SmtpDispatcherAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.smtp_call.plugin", 
...
async def test_should_set_up_plugin_segment_profile_action():
    ...
    module = import_package("wf.plugin.v1.segmentation.force.plugin")
    plugin_class = load_callable(module, "SegmentProfileAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.segmentation.force.plugin", 
...
async def test_should_set_up_plugin_has_segment_action():
    ...
    module = import_package("wf.plugin.v1.segmentation.has.plugin")
    plugin_class = load_callable(module, "HasSegmentAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.segmentation.has.plugin", 
...
async def test_should_set_up_plugin_profile_segment_action():
    ...
    module = import_package("wf.plugin.v1.segmentation.conditional.plugin")
    plugin_class = load_callable(module, "ProfileSegmentAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.segmentation.conditional.plugin", 
...
async def test_should_set_up_plugin_add_segment_action():
    ...
    module = import_package("wf.plugin.v1.segmentation.add.plugin")
    plugin_class = load_callable(module, "AddSegmentAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.segmentation.add.plugin", 
...
async def test_should_set_up_plugin_delete_segment_action():
    ...
    module = import_package("wf.plugin.v1.segmentation.delete.plugin")
    plugin_class = load_callable(module, "DeleteSegmentAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.segmentation.delete.plugin", 
...
async def test_should_set_up_plugin_move_segment_action():
    ...
    module = import_package("wf.plugin.v1.segmentation.move.plugin")
    plugin_class = load_callable(module, "MoveSegmentAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.segmentation.move.plugin", 
...
async def test_should_set_up_plugin_add_interest_action():
    ...
    module = import_package("wf.plugin.v1.interest.add.plugin")
    plugin_class = load_callable(module, "AddInterestAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.interest.add.plugin", 
...
async def test_should_set_up_plugin_increase_interest_action():
    ...
    module = import_package("wf.plugin.v1.interest.increase.plugin")
    plugin_class = load_callable(module, "IncreaseInterestAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.interest.increase.plugin", 
...
async def test_should_set_up_plugin_decrease_interest_action():
    ...
    module = import_package("wf.plugin.v1.interest.decrease.plugin")
    plugin_class = load_callable(module, "DecreaseInterestAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.interest.decrease.plugin", 
...
async def test_should_set_up_plugin_object_to_json_action():
    ...
    module = import_package("wf.plugin.v1.converters.data_to_json.plugin")
    plugin_class = load_callable(module, "ObjectToJsonAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.converters.data_to_json.plugin", 
...
async def test_should_set_up_plugin_json_to_object_action():
    ...
    module = import_package("wf.plugin.v1.converters.json_to_data.plugin")
    plugin_class = load_callable(module, "JsonToObjectAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.converters.json_to_data.plugin", 
...
async def test_should_set_up_plugin_discord_web_hook_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.discord.push.plugin")
    plugin_class = load_callable(module, "DiscordWebHookAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.discord.push.plugin", 
...
async def test_should_set_up_plugin_geo_i_p_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.maxmind.geoip.plugin")
    plugin_class = load_callable(module, "GeoIPAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.maxmind.geoip.plugin", 
...
async def test_should_set_up_plugin_weather_action():
    ...
    module = import_package("wf.plugin.v1.connectors.weather.msn_weather.plugin")
    plugin_class = load_callable(module, "WeatherAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.weather.msn_weather.plugin", 
...
async def test_should_set_up_plugin_token_getter(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.oauth2_token.plugin")
    plugin_class = load_callable(module, "TokenGetter")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.oauth2_token.plugin", 
...
async def test_should_set_up_plugin_slack_poster(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.slack.send_message.plugin")
    plugin_class = load_callable(module, "SlackPoster")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.slack.send_message.plugin", 
...
async def test_should_set_up_plugin_google_sheets_integrator_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.google.sheets.modify.plugin")
    plugin_class = load_callable(module, "GoogleSheetsIntegratorAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.google.sheets.modify.plugin", 
...
async def test_should_set_up_plugin_twitter_tweet_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.twitter.tweet.plugin")
    plugin_class = load_callable(module, "TwitterTweetAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.twitter.tweet.plugin", 
...
async def test_should_set_up_plugin_event_source_fetcher_action():
    ...
    module = import_package("wf.plugin.v1.internal.event_source_fetcher.plugin")
    plugin_class = load_callable(module, "EventSourceFetcherAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.internal.event_source_fetcher.plugin", 
...
async def test_should_set_up_plugin_add_empty_profile_action():
    ...
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.internal.add_empty_profile.plugin", 
...
async def test_should_set_up_plugin_previous_event_getter():
    ...
    module = import_package("wf.plugin.v1.internal.get_prev_event.plugin")
    plugin_class = load_callable(module, "PreviousEventGetter")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.internal.get_prev_event.plugin", 
...
async def test_should_set_up_plugin_create_response_action():
    ...
    module = import_package("wf.plugin.v1.internal.add_response.plugin")
    plugin_class = load_callable(module, "CreateResponseAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.internal.add_response.plugin", 
...
async def test_should_set_up_plugin_key_counter_action():
    ...
    module = import_package("wf.plugin.v1.metrics.key_counter.plugin")
    plugin_class = load_callable(module, "KeyCounterAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.metrics.key_counter.plugin", 
...
async def test_should_set_up_plugin_consent_adder():
    ...
    module = import_package("wf.plugin.v1.consents.add_consent_action.plugin")
    plugin_class = load_callable(module, "ConsentAdder")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.consents.add_consent_action.plugin", 
...
async def test_should_set_up_plugin_require_consents_action():
    ...
    module = import_package("wf.plugin.v1.consents.require_consents_action.plugin")
    plugin_class = load_callable(module, "RequireConsentsAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.consents.require_consents_action.plugin", 
...
async def test_should_set_up_plugin_contains_string_action():
    ...
    module = import_package("wf.plugin.v1.contains_string_action")
    plugin_class = load_callable(module, "ContainsStringAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.contains_string_action", 
...
async def test_should_set_up_plugin_base64_encode_action():
    ...
    module = import_package("wf.plugin.v1.converters.base64.encode.plugin")
    plugin_class = load_callable(module, "Base64EncodeAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.converters.base64.encode.plugin", 
...
async def test_should_set_up_plugin_base64_decode_action():
    ...
    module = import_package("wf.plugin.v1.converters.base64.decode.plugin")
    plugin_class = load_callable(module, "Base64DecodeAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.converters.base64.decode.plugin", 
...
async def test_should_set_up_plugin_sort_array_action():
    ...
    module = import_package("wf.plugin.v1.sort_array_action")
    plugin_class = load_callable(module, "SortArrayAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.sort_array_action", 
...
async def test_should_set_up_plugin_git_hub_list_issues_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.github.issues.list.plugin")
    plugin_class = load_callable(module, "GitHubListIssuesAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.github.issues.list.plugin", 
...
async def test_should_set_up_plugin_git_hub_get_issue_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.github.issues.get.plugin")
    plugin_class = load_callable(module, "GitHubGetIssueAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.github.issues.get.plugin", 
...
async def test_should_set_up_plugin_query_local_database():
    ...
    module = import_package("wf.plugin.v1.connectors.elasticsearch.query_local.plugin")
    plugin_class = load_callable(module, "QueryLocalDatabase")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.elasticsearch.query_local.plugin", 
...
async def test_should_set_up_plugin_elastic_search_fetcher(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.elasticsearch.query.plugin")
    plugin_class = load_callable(module, "ElasticSearchFetcher")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.elasticsearch.query.plugin", 
...
async def test_should_set_up_plugin_sms77_send_sms_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.sms77.sendsms.plugin")
    plugin_class = load_callable(module, "Sms77SendSmsAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.sms77.sendsms.plugin", 
...
async def test_should_set_up_plugin_influx_sender(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.influxdb.send.plugin")
    plugin_class = load_callable(module, "InfluxSender")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.influxdb.send.plugin", 
...
async def test_should_set_up_plugin_influx_fetcher(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.influxdb.fetch.plugin")
    plugin_class = load_callable(module, "InfluxFetcher")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.influxdb.fetch.plugin", 
...
async def test_should_set_up_plugin_elastic_email_contact_adder(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.elastic_email.add_contact.plugin")
    plugin_class = load_callable(module, "ElasticEmailContactAdder")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.elastic_email.add_contact.plugin", 
...
async def test_should_set_up_plugin_elastic_email_contact_status_change(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.elastic_email.contact_status_change.plugin")
    plugin_class = load_callable(module, "ElasticEmailContactStatusChange")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.elastic_email.contact_status_change.plugin", 
...
async def test_should_set_up_plugin_elastic_email_transactional_mail_sender(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.elastic_email.transactional_email.plugin")
    plugin_class = load_callable(module, "ElasticEmailTransactionalMailSender")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.elastic_email.transactional_email.plugin", 
...
async def test_should_set_up_plugin_elastic_email_bulk_mail_sender(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.elastic_email.bulk_email.plugin")
    plugin_class = load_callable(module, "ElasticEmailBulkMailSender")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.elastic_email.bulk_email.plugin", 
...
async def test_should_set_up_plugin_sendgrid_contact_adder(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.sendgrid.add_contact_to_list.plugin")
    plugin_class = load_callable(module, "SendgridContactAdder")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.sendgrid.add_contact_to_list.plugin", 
...
async def test_should_set_up_plugin_sendgrid_global_suppression_adder(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.sendgrid.add_email_to_global_suppression.plugin")
    plugin_class = load_callable(module, "SendgridGlobalSuppressionAdder")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.sendgrid.add_email_to_global_suppression.plugin", 
...
async def test_should_set_up_plugin_sendgrid_e_mail_sender(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.sendgrid.send_email.plugin")
    plugin_class = load_callable(module, "SendgridEMailSender")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.sendgrid.send_email.plugin", 
...
async def test_should_set_up_plugin_postgre_s_q_l_connector_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.postgresql.query.plugin")
    plugin_class = load_callable(module, "PostgreSQLConnectorAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.postgresql.query.plugin", 
...
async def test_should_set_up_plugin_mongo_connector_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mongo.query.plugin")
    plugin_class = load_callable(module, "MongoConnectorAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mongo.query.plugin", 
...
async def test_should_set_up_plugin_mysql_connector_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mysql.query.plugin")
    plugin_class = load_callable(module, "MysqlConnectorAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mysql.query.plugin", 
...
async def test_should_set_up_plugin_data_extension_sender(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.salesforce.marketing_cloud.send.plugin")
    plugin_class = load_callable(module, "DataExtensionSender")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.salesforce.marketing_cloud.send.plugin", 
...
async def test_should_set_up_plugin_zapier_web_hook_action():
    ...
    module = import_package("wf.plugin.v1.connectors.zapier.webhook.plugin")
    plugin_class = load_callable(module, "ZapierWebHookAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.zapier.webhook.plugin", 
...
async def test_should_set_up_plugin_mqtt_publish_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mqtt.publish.plugin")
    plugin_class = load_callable(module, "MqttPublishAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mqtt.publish.plugin", 
...
async def test_should_set_up_plugin_mix_panel_sender(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mixpanel.send.plugin")
    plugin_class = load_callable(module, "MixPanelSender")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mixpanel.send.plugin", 
...
async def test_should_set_up_plugin_mix_panel_funnel_fetcher(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mixpanel.fetch_funnel.plugin")
    plugin_class = load_callable(module, "MixPanelFunnelFetcher")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mixpanel.fetch_funnel.plugin", 
...
async def test_should_set_up_plugin_send_to_airtable_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.airtable.send_record.plugin")
    plugin_class = load_callable(module, "SendToAirtableAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.airtable.send_record.plugin", 
...
async def test_should_set_up_plugin_fetch_from_airtable_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.airtable.fetch_records.plugin")
    plugin_class = load_callable(module, "FetchFromAirtableAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.airtable.fetch_records.plugin", 
...
async def test_should_set_up_plugin_send_event_to_matomo_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.matomo.send_event.plugin")
    plugin_class = load_callable(module, "SendEventToMatomoAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.matomo.send_event.plugin", 
...
async def test_should_set_up_plugin_hub_spot_company_adder(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.hubspot.add_company.plugin")
    plugin_class = load_callable(module, "HubSpotCompanyAdder")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.hubspot.add_company.plugin", 
...
async def test_should_set_up_plugin_hub_spot_contact_adder(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.hubspot.add_contact.plugin")
    plugin_class = load_callable(module, "HubSpotContactAdder")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.hubspot.add_contact.plugin", 
...
async def test_should_set_up_plugin_hub_spot_company_getter(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.hubspot.get_company.plugin")
    plugin_class = load_callable(module, "HubSpotCompanyGetter")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.hubspot.get_company.plugin", 
...
async def test_should_set_up_plugin_hub_spot_contact_getter(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.hubspot.get_contact.plugin")
    plugin_class = load_callable(module, "HubSpotContactGetter")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.hubspot.get_contact.plugin", 
...
async def test_should_set_up_plugin_hub_spot_company_updater(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.hubspot.update_company.plugin")
    plugin_class = load_callable(module, "HubSpotCompanyUpdater")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.hubspot.update_company.plugin", 
...
async def test_should_set_up_plugin_hub_spot_contact_updater(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.hubspot.update_contact.plugin")
    plugin_class = load_callable(module, "HubSpotContactUpdater")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.hubspot.update_contact.plugin", 
...
async def test_should_set_up_plugin_full_contact_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.full_contact.person_enrich.plugin")
    plugin_class = load_callable(module, "FullContactAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.full_contact.person_enrich.plugin", 
...
async def test_should_set_up_plugin_fetch_active_campaign_profile_by_email_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.active_campaign.fetch_by_email.plugin")
    plugin_class = load_callable(module, "FetchActiveCampaignProfileByEmailAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.active_campaign.fetch_by_email.plugin", 
...
async def test_should_set_up_plugin_send_to_active_campaign_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.active_campaign.add_contact.plugin")
    plugin_class = load_callable(module, "SendToActiveCampaignAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.active_campaign.add_contact.plugin", 
...
async def test_should_set_up_plugin_rabbit_publisher_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.rabbitmq.publish.plugin")
    plugin_class = load_callable(module, "RabbitPublisherAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.rabbitmq.publish.plugin", 
...
async def test_should_set_up_plugin_add_civi_contact_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.civi_crm.add_contact.plugin")
    plugin_class = load_callable(module, "AddCiviContactAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.civi_crm.add_contact.plugin", 
...
async def test_should_set_up_plugin_amplitude_send_event(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.amplitude.send_events.plugin")
    plugin_class = load_callable(module, "AmplitudeSendEvent")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.amplitude.send_events.plugin", 
...
async def test_should_set_up_plugin_aws_sqs_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.aws.sqs.plugin")
    plugin_class = load_callable(module, "AwsSqsAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.aws.sqs.plugin", 
...
async def test_should_set_up_plugin_scheduler_plugin(mocker):
    ...
    module = import_package("wf.plugin.v1.pro.scheduler.plugin")
    plugin_class = load_callable(module, "SchedulerPlugin")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.pro.scheduler.plugin", 
...
async def test_should_set_up_plugin_novu_trigger_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.novu.trigger.plugin")
    plugin_class = load_callable(module, "NovuTriggerAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.novu.trigger.plugin", 
...
async def test_should_set_up_plugin_pushover_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.pushover.push.plugin")
    plugin_class = load_callable(module, "PushoverAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.pushover.push.plugin", 
...
async def test_should_set_up_plugin_sentiment_analysis_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.meaningcloud.sentiment_analysis.plugin")
    plugin_class = load_callable(module, "SentimentAnalysisAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.meaningcloud.sentiment_analysis.plugin", 
...
async def test_should_set_up_plugin_language_detect_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.meaningcloud.language_detection.plugin")
    plugin_class = load_callable(module, "LanguageDetectAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.meaningcloud.language_detection.plugin", 
...
async def test_should_set_up_plugin_text_classification_action(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.meaningcloud.text_classification.plugin")
    plugin_class = load_callable(module, "TextClassificationAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.meaningcloud.text_classification.plugin", 
...
async def test_should_set_up_plugin_corporate_reputation_plugin(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.meaningcloud.corporate_reputation.plugin")
    plugin_class = load_callable(module, "CorporateReputationPlugin")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.meaningcloud.corporate_reputation.plugin", 
...
async def test_should_set_up_plugin_topics_extraction_plugin(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.meaningcloud.topics_extraction.plugin")
    plugin_class = load_callable(module, "TopicsExtractionPlugin")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.meaningcloud.topics_extraction.plugin", 
...
async def test_should_set_up_plugin_summarization_plugin(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.meaningcloud.summarization.plugin")
    plugin_class = load_callable(module, "SummarizationPlugin")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.meaningcloud.summarization.plugin", 
...
async def test_should_set_up_plugin_deep_categorization_plugin(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.meaningcloud.deep_categorization.plugin")
    plugin_class = load_callable(module, "DeepCategorizationPlugin")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.meaningcloud.deep_categorization.plugin", 
...
async def test_should_set_up_plugin_mautic_contact_adder(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mautic.add_contact.plugin")
    plugin_class = load_callable(module, "MauticContactAdder")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mautic.add_contact.plugin", 
...
async def test_should_set_up_plugin_mautic_contact_by_i_d_fetcher(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mautic.fetch_contact_by_id.plugin")
    plugin_class = load_callable(module, "MauticContactByIDFetcher")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mautic.fetch_contact_by_id.plugin", 
...
async def test_should_set_up_plugin_mautic_contact_by_email_fetcher(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mautic.fetch_contact_by_email.plugin")
    plugin_class = load_callable(module, "MauticContactByEmailFetcher")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mautic.fetch_contact_by_email.plugin", 
...
async def test_should_set_up_plugin_mautic_points_editor(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mautic.edit_points.plugin")
    plugin_class = load_callable(module, "MauticPointsEditor")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mautic.edit_points.plugin", 
...
async def test_should_set_up_plugin_mautic_segment_editor(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mautic.add_remove_segment.plugin")
    plugin_class = load_callable(module, "MauticSegmentEditor")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mautic.add_remove_segment.plugin", 
...
async def test_should_set_up_plugin_transactional_mail_sender(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mailchimp.transactional_email.plugin")
    plugin_class = load_callable(module, "TransactionalMailSender")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mailchimp.transactional_email.plugin", 
...
async def test_should_set_up_plugin_mail_chimp_audience_adder(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mailchimp.add_to_audience.plugin")
    plugin_class = load_callable(module, "MailChimpAudienceAdder")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mailchimp.add_to_audience.plugin", 
...
async def test_should_set_up_plugin_mail_chimp_audience_remover(mocker):
    ...
    module = import_package("wf.plugin.v1.connectors.mailchimp.remove_from_audience.plugin")
    plugin_class = load_callable(module, "MailChimpAudienceRemover")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.connectors.mailchimp.remove_from_audience.plugin", 
...
async def test_should_set_up_plugin_write_to_memory_action(mocker):
    ...
    module = import_package("wf.plugin.v1.operations.write_to_memory.plugin")
    plugin_class = load_callable(module, "WriteToMemoryAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.operations.write_to_memory.plugin", 
...
async def test_should_set_up_plugin_read_from_memory_action(mocker):
    ...
    module = import_package("wf.plugin.v1.operations.read_from_memory.plugin")
    plugin_class = load_callable(module, "ReadFromMemoryAction")
    plugin = plugin_class()
    plugin.node = Node(id="node-id", 
                       name="test-node", 
                       module="wf.plugin.v1.operations.read_from_memory.plugin", 
