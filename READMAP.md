...
* Enhance Marketer-Focused User Interface
  [x] Introduce a unified segments list, including illustrative examples of segmented profiles.
  [x] Standardize all segmentation processes.
  [x] Enable manual synchronization of profiles with profile destinations (Customer activations).
