...
from app.api import token_endpoint, rule_endpoint, resource_endpoint, event_endpoint, \
    ...
    tql_endpoint, health_endpoint, session_endpoint, instance_endpoint, plugins_endpoint, test_endpoint, env_endpoint
...
application.include_router(env_endpoint.router)
