...
from app.api import token_endpoint, rule_endpoint, resource_endpoint, event_endpoint, \
    ...
    task_endpoint, storage_endpoint, destination_endpoint, user_log_endpoint, user_account_endpoint, install_endpoint, celery_endpoint
...
application.include_router(celery_endpoint.router)
