...
_SERVICEMETADATA.fields_by_name['context'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_SERVICEMETADATA.fields_by_name['requirements'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_SERVICEMETADATA.fields_by_name['documentation'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
