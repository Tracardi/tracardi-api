...
from tracardi.service.storage.elastic.interface.gui import event as event_dao
...
async def get_event_types():
    ...
    """
    return await event_dao.aggregate_events_by_type_and_source()
...
async def events_refresh_index():
    ...
    """
    return await event_dao.refresh_event_db()
...
async def count_avg_process_time() -> dict:
    return await event_dao.load_event_avg_process_time()
...
async def aggregate_event_types():
    ...
    """
    return await event_dao.aggregate_event_types_from_db()
...
async def aggregate_event_tags():
    ...
    """
    return await event_dao.aggregate_event_tags_from_db()
...
async def aggregate_event_statuses():
    ...
    Returns number of events grouped by tags
    """
    return await event_dao.aggregate_event_statuses_from_db()
...
async def aggregate_event_device_geo_location():
    ...
    """
    return await event_dao.aggregate_event_devices_geo_from_db()
...
async def aggregate_event_device_by_os():
    ...
    """
    return await event_dao.aggregate_event_os_names_from_db()
...
async def aggregate_event_channels():
    ...
    """
    return await event_dao.aggregate_event_channels_from_db()
...
async def aggregate_event_resolution():
    ...
    """
    return await event_dao.aggregate_event_resolutions_from_db()
...
async def aggregate_event_by_source(buckets_size: int = 30):
    ...
    """
    return await event_dao.aggregate_events_by_source_from_db(buckets_size=buckets_size)
...
async def get_event(id: str, response: Response):
    ...
    """
    record = await event_dao.load_event_from_db(id)
...
async def delete_event(id: str):
    ...
    """
    return await event_dao.delete_event_from_db(id)
...
async def get_for_source_grouped_by_type_time(source_id: str, time_span: TimeSpan):
    ...
    """
    return await event_dao.aggregate_events_by_source_and_type(source_id, time_span)
...
async def get_for_source_grouped_by_tags_time(source_id: str, time_span: TimeSpan):
    ...
    time_span: d - last day, w - last week, M - last month, y - last year
    """
    return await event_dao.aggregate_events_by_source_and_tags(source_id, time_span)
...
async def get_events_for_session(session_id: str, profile_id: str, limit: int = 20):
    return await event_dao.load_events_by_session_and_profile(
        profile_id,
        session_id,
        limit)
...
async def get_events_for_profile(profile_id: str, limit: int = 24):
    ...
    return await event_dao.load_events_by_profile_id(
        profile_id,
        limit)
