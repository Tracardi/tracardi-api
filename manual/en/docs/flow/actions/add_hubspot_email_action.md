# Add email to HubSpot plugin

This plugin adds new marketing email to HubSpot, based on provided data.
...
* scopes: for adding contact, you need to choose content scope, but this match only with this 
  and Add Email to HubSpot plugin. For other plugins connecting to HubSpot, you should choose other scopes.   
...
* is token got - please select true if you've got access token. If you select false and then make any operation 
  ...
  will do it for you.
* properties - you can add properties for your contact. Remember to use field aliases from HubSpot. Moreover, you have to 
add 'name' field
